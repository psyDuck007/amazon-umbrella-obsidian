...
- 中文用于内部判断，英文用于 Amazon 消息发送。
- 英文必须比中文更克制，避免情绪化、承诺过度或合规风险。
- 所有金额、时间、tracking、配件名称、补发内容必须按真实订单替换。
...
| 信用卡拒付邮件中的退货地址 | **Return shipping address:**<br>Jim<br>VILIA SUPPLY CHAIN INC<br>130 SCOTT RD STE 4, BLDG 4<br>WATERBURY, CT 06705-5204<br>United States |

## 禁用表达对照

| 中文风险意图 | 不要写 |
|---|---|
| 用退款换改评 | We will refund you if you change your review. |
| 请求删差评 | Please remove your negative review. |
| 承诺防风 | This umbrella is windproof. |
| 承诺不会倾倒 | It will never tip over. |
| 让买家站外联系 | Please email/call/text us outside Amazon. |

## 待确认

- 是否需要按“物流、破损、缺件、灯光、退货、补发”建立完整中英文模板库。
- 已确认配件的标准中英文名称。
...
| 日期 | 对象 | 内容 | 依据 | 状态 | 备注 |
|---|---|---|---|---|---|
| 2026-06-12 | 信用卡拒付/款项争议 | 新增退货地址中英文对照 | 用户提供 | 已归纳 | 不自动附加退款、补发或运费承诺 |
